...
export default class PastPurchases extends Component<PastPurchasesProps, PastPurchasesState> {
  ...
  getPrettyDate = (orderDate: number) => {
    ...
    return `${date.getMonth()}/${date.getDate()}/${date.getDay()} ${date.getHours()}:${date.getMinutes() < 10 ? '0' : ''}${date.getMinutes()}`
  }
    ...
    return (
      <div className="Category">
        ...
        <div className="well-bs col-md-12">
          ...
          <a href=""><img src={bestSellers} alt="Best sellers" className="checkout-img no-padding" /></a>
          <a href=""><img src={yourshoppingcart} alt="Shopping cart" className="checkout-img no-padding" /></a>
